...
def image_data_split(args, data):
    ...
    data['train'].loc[train_idx].to_csv(f'./data_index/image_data_train_index.csv', index=False)
    data['train'].loc[valid_idx].to_csv(f'./data_index/image_data_valid_index.csv', index=False)
    return data
